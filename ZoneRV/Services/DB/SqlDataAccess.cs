...
public abstract class SqlDataAccess
{
    ...
    public abstract Task<IEnumerable<T>> LoadData<T, U>(string storedProcedure, U parameters, string connectionId = "Default");
    
    public abstract Task SaveData<T>(string storedProcedure, T parameters, string connectionId = "Default");
