...
namespace ZoneRV.Migrations.Migrations
{
    ...
    [Migration("20250203235059_ReRefactoredLocations")]
    partial class ReRefactoredLocations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ZoneRV.Models.Location.LocationInventoryName", b =>
                {
                    ...
                    b.Property<int?>("OrderedLineLocationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OrderedLineLocationId");
            ...
            modelBuilder.Entity("ZoneRV.Models.Location.LocationInventoryName", b =>
                {
                    ...
                    b.HasOne("ZoneRV.Models.Location.OrderedLineLocation", null)
                        .WithMany("InventoryNames")
                        .HasForeignKey("OrderedLineLocationId");
